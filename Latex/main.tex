...
%% Section 1
\input{Latex/Sections/Symbols/symbols}
...
\input{Latex/Sections/ControllerDesign/polePlacement}
\input{Latex/Sections/ControllerDesign/MPC}
\clearpage
\input{Latex/Sections/ControllerDesign/ControllerResults}
 \clearpage
 \newpage
\section{Conclusion}
\input{Latex/Sections/ConclusionDiscussion/Conlcusion}
\section{Discussion}
\input{Latex/Sections/ConclusionDiscussion/Discussion}
%%%%%%%% EXTRA TIPS %%%%%%%%
