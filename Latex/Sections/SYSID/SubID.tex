...
% The system matrices determined with the MOESP method ($n=7,\ s=150$) are
% A_T
% B_T
% C_T
% D_T
...
From figure \ref{fig:Comp_subID} it can be seen that the model determined with MOESP, given the same input, mostly coincides with the experiment data. He   