...
% \end{figure}
From figure \ref{fig:comp_Kalman} it can be seen that the output estimated with the Kalman filter slowly converges to the measured output. For Heater 1 this is achieved after approximately     
